...
HF_CHECKPOINT_DIR=/home/ext_kazuki_fujii_turing_motors_c/checkpoints/megatron-to-hf/Llama-2-7b-hf

mkdir -p ${MEGATRON_CHECKPOINT_DIR}

# tokenizer config
TOKENIZER_MODEL_DIR=/home/ext_kazuki_fujii_turing_motors_c/hf-checkpoints/Llama-2-7b-hf/
