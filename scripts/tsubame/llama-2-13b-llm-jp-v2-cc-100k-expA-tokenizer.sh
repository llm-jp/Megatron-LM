...
# swich virtual env
source /gs/bs/tga-NII-LLM/src/Megatron-LM-mdx/.env/bin/activate
...
# model config
TOKENIZER_MODEL=/gs/bs/tga-NII-LLM/src/llm-jp-tokenizer/models/ver3.0/llm-jp-tokenizer-100k.ver3.0b1.model
CHECKPOINT_SAVE_DIR=/gs/bs/tgh-NII-LLM/checkpoints/Llama-2-13b/CC_v2_code20K_en40K_ja60K_ver2.2/expA-tokenizer/
