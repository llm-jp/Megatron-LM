...
CHECKPOINT_SAVE_DIR=/data/checkpoints_7b/okazaki_cc_code10K_en20K_ja30K_ver2.2
...
TRAIN_DATA_PATH="${TRAIN_DATA_PATH} 16110605436 ${DATASET_DIR}/okazaki_cc/okazaki_cc_merge_0_text_document"
TRAIN_DATA_PATH="${TRAIN_DATA_PATH} 15905409373 ${DATASET_DIR}/okazaki_cc/okazaki_cc_merge_1_text_document"
TRAIN_DATA_PATH="${TRAIN_DATA_PATH} 18964229542 ${DATASET_DIR}/okazaki_cc/okazaki_cc_merge_2_text_document"
TRAIN_DATA_PATH="${TRAIN_DATA_PATH} 25012932248 ${DATASET_DIR}/okazaki_cc/okazaki_cc_merge_3_text_document"
TRAIN_DATA_PATH="${TRAIN_DATA_PATH} 58384447702 ${DATASET_DIR}/okazaki_cc/okazaki_cc_merge_4_text_document"
