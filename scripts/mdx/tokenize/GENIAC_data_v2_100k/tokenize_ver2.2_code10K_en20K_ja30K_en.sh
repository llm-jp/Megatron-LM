...
OUTPUT_DIR="/data/llm-jp-corpus/v3.0.0/training_resharded_tokenize_ver2.2_code10K_en20K_ja30K.ver2.2/train/en"
OUTPUT_TOKEN_INFO="/model/llmjp0/Megatron-LM/scripts/mdx/tokenize/GENIAC_data_v2_100k/token_info/2024_0510_en.csv"
mkdir -p $OUTPUT_DIR
