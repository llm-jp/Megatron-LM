...
CHECKPOINT_SAVE_DIR=/home/ext_taishi_nakamura_rio_gsic_tit/checkpoints/Llama-2-13b/exp3/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-ct${CONTEXT_PARALLEL_SIZE}
