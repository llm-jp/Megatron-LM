...
#SBATCH --output=outputs/llama-2-175b-exp2/%x-%j.out
#SBATCH --error=outputs/llama-2-175b-exp2/%x-%j.out
...
CHECKPOINT_SAVE_DIR=/lustre/checkpoints/llama-2-172b-exp2/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-cp${CONTEXT_PARALLEL_SIZE}
