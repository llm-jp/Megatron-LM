...
OUTPUT_DIR="/data/llm-jp-corpus/v3.0.0/training_resharded_tokenize_ver3.0/train/ko"
OUTPUT_TOKEN_INFO="/model/llmjp0/Megatron-LM/scripts/mdx/tokenize/GENIAC/token_info/2024_0410_ko.csv"
mkdir -p $OUTPUT_DIR
