#!/bin/bash
#SBATCH --job-name=llama-2-1.7b-exp2
...
# model config
TOKENIZER_MODEL=/model/llmjp0/llm-jp-tokenizer/models/ver3.0/llm-jp-tokenizer-100k.ver3.0b1.model
CHECKPOINT_SAVE_DIR=/model/checkpoints_llama2_1.7B_exp2/tp${TENSOR_PARALLEL_SIZE}-pp${PIPELINE_PARALLEL_SIZE}-cp${CONTEXT_PARALLEL_SIZE}

mkdir -p ${CHECKPOINT_SAVE_DIR}

# data config
DATASET_DIR=/data/llm-jp-corpus/v3.0.0/training_resharded_tokenize_ver3.0
DATASET_V3_1_DIR=/model/llm-jp-corpus/v3.1.0/tokenize/v3.0b1
